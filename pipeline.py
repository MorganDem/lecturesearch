...
class Pipeline:
	...
	def get_captionpath(self, yt):
		...
		caption_path = join(self.dataset_path, f'{yt.title}')
	...
	def get_videopath(self, yt):
		try:
			...
			video_path = join(self.dataset_path, f'{yt.title}')
	...
	def get_audiopath(self, yt):
		try:
			...
			audio_path = join(self.dataset_path, f'{yt.title}')
	...
	def download_data(self, link):
		...
		try:
			...
			if not self.data_dict[link]:
				...
				mkdir(join(self.dataset_path, f'{yt.title}'))
